...
namespace MimicSpace
{
    public class Mimic : MonoBehaviour
    {
        ...
        [Tooltip("Minimum lerp coefficient for leg growth smoothing")]
        public float minGrowCoef = 4.5f;
        [Tooltip("Maximum lerp coefficient for leg growth smoothing")]
        public float maxGrowCoef = 6.5f;

        [Tooltip("Minimum duration before a new leg can be placed")]
        public float newLegCooldown = 0.3f;

        [Tooltip("Attack range of the Mimic")]
        public float attackRange = 2f; // Define el rango de ataque aquí
        ...
        void Die()
        {
            Debug.Log("Mimic died!");
            // Aquí puedes agregar lógica para destruir al Mimic y mostrar una pantalla de fin de juego, reiniciar nivel, etc.
            Destroy(gameObject); // Destruye al Mimic cuando muere
        }
        ...
        public void Attack()
        {
            ...
            // Puedes agregar más lógica de ataque aquí según sea necesario
        }
    }
}
