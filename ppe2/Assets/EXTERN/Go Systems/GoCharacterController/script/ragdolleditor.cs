...
{
   public class ragdolleditor : ScriptableWizard
    {
       ...
       static ArrayList bones;
        static BoneInfo rootBone;
       ...
       void AddBreastColliders()
        {
            ...
            if (middleSpine != null && root != null)
            {
                ...
                box = Undo.AddComponent<BoxCollider>(root.gameObject);
            ...
            else
            {
                ...
                BoxCollider box = Undo.AddComponent<BoxCollider>(root.gameObject);
                box.center = bounds.center;
                box.size = size;
            }
        }
